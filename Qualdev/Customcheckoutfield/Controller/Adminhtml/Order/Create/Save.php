...
namespace Qualdev\Customcheckoutfield\Controller\Adminhtml\Order\Create;
...
class Save extends \Magento\Sales\Controller\Adminhtml\Order\Create
{
    ...
    public function execute()
    {
        ...
        try {
			...
			$customcheckoutfield = $this->getRequest()->getPost('customcheckoutfield'); 
            if ($paymentData) {
                $paymentData['checks'] = [
			...
			if($customcheckoutfield != ''){ 
				$this->_getOrderCreateModel()->setCustomcheckoutfield($customcheckoutfield);
